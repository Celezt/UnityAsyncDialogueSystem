...
{
    public class MixerBehaviourExtended : UnityEngine.Playables.PlayableBehaviour
    {
        ...
        public bool IsProcessing
        {
            get
            {
                return _currentClips.Any(x => x.Behaviour.ProcessState == PlayableBehaviourExtended.ProcessStates.Processing);
            }
        }
